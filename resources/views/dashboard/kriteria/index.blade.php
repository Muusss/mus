                    ...
                    <div>
                        <form action="{{ route("kriteria.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="kriteria" class="input input-bordered w-full text-affair" value="{{ old("kriteria") }}" required />
                                @error("kriteria")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="number" min="0" max="100" step="1" name="bobot" class="input input-bordered w-full text-affair" value="{{ old("bobot") }}" required />
                                @error("bobot")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                    ...
                    <div>
                        <form action="{{ route("kriteria.update") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="kode" class="input input-bordered w-full cursor-default bg-slate-100 text-affair" required />
                                @error("kode")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="kriteria" class="input input-bordered w-full text-affair" required />
                                @error("kriteria")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="number" min="0" max="100" step="1" name="bobot" class="input input-bordered w-full text-affair" required />
                                @error("bobot")
                                    <div class="label">
                                        <span class="label-text-alt text-sm text-error">{{ $message }}</span>
                                    </div>
                    ...
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                        <table id="myTable" class="nowrap stripe mb-3 w-full max-w-full border-collapse items-center align-top" style="width: 100%;">
                            ...
                            <tr>
                                <td></td>
                                <td></td>
                                <td class="text-right align-middle text-base font-semibold leading-tight text-affair dark:text-zambezi">Total Bobot:</td>
