                        ...
                        <form action="{{ route("penilaian.update") }}" method="POST" enctype="multipart/form-data">
                            ...
                            @foreach ($kriteria as $item)
                                <label class="form-control w-full">
                                    ...
                                    <input type="text" name="kriteria_id[]" id="{{ "kriteria_id_" . $item->id }}" class="input input-bordered w-full text-affair" hidden />
                                    <select name="sub_kriteria_id[]" id="{{ "sub_kriteria_id_" . $item->id }}" class="select select-bordered w-full text-affair" required>
                    ...
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                        ...
                        <div class="w-fit overflow-x-auto">
                            <table class="table table-xs">
                                ...
                                <tr>
                                    <td class="text-base text-affair dark:text-zambezi">* Pastikan setiap alternatif terisi semua</td>
