                    ...
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                        ...
                        <div class="w-fit overflow-x-auto">
                            <table class="table table-xs">
                                ...
                                <tr>
                                    <td class="text-base text-primary-color dark:text-primary-color-dark">* Pastikan telah melakukan perhitungan nilai utility dan normalisasi bobot kriteria</td>
